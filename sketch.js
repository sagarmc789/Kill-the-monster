...
function setup() {
  ...
  minion1 = new Minion(800,50,10,10);
  //minion2 = new Minion(900,50,10,10);
  minion3 = new Minion(700,50,10,10);
  minion4 = new Minion(600,50,10,10);
